...
public abstract class Referee {
    ...
    public static void displayResultBattle(int resultBattle, Player player1, Player player2){
    ...
    public static void displayHandlePacket(){
    ...
    public static void displayChallenge(Player player1, Player player2){
    ...
    public static void distribute(Player player1, Player player2){
